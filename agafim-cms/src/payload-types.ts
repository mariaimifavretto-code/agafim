...
export interface Post {
  ...
  slug: string;
  /**
   * Resumo do post para exibição em listas
   */
  summary: string;
  content: {
    root: {
...
export interface Noticia {
  ...
  slug: string;
  /**
   * Resumo da notícia para exibição em listas
   */
  summary: string;
  content: {
    root: {
...
export interface Denuncia {
  id: number;
  /**
   * Tipo da denúncia ou comunicação
   */
  type: 'denuncia' | 'sugestao' | 'outro';
  /**
   * Descrição detalhada da denúncia ou sugestão
   */
  description: string;
  /**
   * E-mail opcional do denunciante para contato
   */
  email?: string | null;
  updatedAt: string;
  createdAt: string;
